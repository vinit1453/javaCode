...
<body>
	...
	<form  id="myForm" style="width:100%" action="<%=update%>" method="post">
			...
			<div class="toggle-content"
				...
				<table id="table8" style="font-family: 'tahoma';">
					...
					<tr>
						...
						<td><input type="text" class="t1" id="dateonQuote" name="dateonQuote" ><span id="calendar7"
						...
						<tr>
							...
							<td><input type="text" class="t1"  id="projectCost" name="projectCost"></td>
							<td style="width: 112px"></td>
							<td class="l1"><label class="labels">Overall Project
									Sell(�)<span class="error"> *</span>
							</label></td>
							<td><input type="text" class="t1" id="projectSell" name="projectSell"></td>
						</tr>
					</table>
				<div id="drop4">
				<div class="drop">
		...
		<textarea rows="4"  class="t1" style="width:98%;max-width: 100%" id="comments" name="comments"></textarea>
	...
	var ch1=document.getElementById("ch1");
	    ...
	    var survey=document.getElementById('survey');
		 if (survey.value == null || survey.value == "" || survey.value=="Select") {
			...
			if(siteExp.value==null || siteExp.value=="" || siteExp.value=="Select" || siteExp.value=="select"){
