...
<p:defineObjects />
<p:actionURL name="form2" var="update"></p:actionURL>
<html lang="en">
<head>
	    ...
	    $("#inp3").focus();
	  	 ...
	  	 $("#inp4").datepicker({dateFormat: 'dd/mm/yy',numberOfMonths: 3, showCurrentAtPos:0,minDate:$("#inp3").val()});
		    ...
		    $("#aod").focus();
		  	...
		  	$("#dateonQuote").datepicker({dateFormat: 'dd/mm/yy',numberOfMonths: 3, showCurrentAtPos:0});
		  	$('#calendar7').click(function() {
...
<body>
	<div style="width:100%">
	    <% Project prj=new Project();
						...
						String st=prj.getFormData(qrn);
						Gson gson = new Gson();  
						JSONObject obj =  JSONFactoryUtil.createJSONObject(st);
						
						%> 
			<%-- <% String str=request.getParameter("qrn"); 
			         %> --%>			  
	<form  id="myForm" style="width:100%" action="<%=update%>" method="post">
		<div class="toggle1">
				...
				<fieldset
					...
					<table id="table1" style="font-family: 'tahoma';">
						<tr>
							...
							<td><input type="text" class="t1" id="cna" name="customer" value="<%=obj.getString("customer")%>"><span
						...
						<tr>
							<td class="l1"><label class="labels">Customer
									Address</label></td>
							<td><textarea rows="4" cols="70" class="t1" id="cAdd" name="cAdd"
									style="width: 270px;"><%=obj.getString("cAdd")%></textarea><span class="chat"> <i
									class="bi bi-chat-dots"></i></span></td>
							<td class="l1"><label class="labels"
								style="margin-left: 160px;">Postal Code</label></td>
							<td><input type="text" class="t1" id="pCode" name="pCode" value="<%=obj.getString("pCode")%>"><span class="chat">
						...
						<tr>
							...
							<td><input type="text" class="t1" id="conName" name="conName" value="<%=obj.getString("conName")%>"></td>
							<td><label class="labels" style="margin-left: 202px;">Email<span
									class="error">*</span></label></td>
							<td><input type="text" class="t1" id="email" name="email" value="<%=obj.getString("email")%>"></td>
						</tr>

						<tr>
							<td class="l1"><label class="labels">Phone<span
									class="error">*</span></label></td>
							<td><input type="text" class="t1" id="ph" name="ph" value="<%=obj.getString("phone")%>"></td>
						</tr>
					</table>
				</fieldset>
				<br>
				...
				<fieldset
					...
					<table id="table2" style="font-family: 'tahoma';">
						<tr>
							...
							<td><input type="text" class="t1" id="pname" name="projectName" value="<%=obj.getString("projectName")%>" readonly><span
								class="chat"> <i class="bi bi-chat-dots"></i></span></td>
							<td class="l1"><label class="labels">Site Name</label></td>
							<td><input type="text" class="t1" id="sname" name="siteName" value="<%=obj.getString("siteName")%>"> <span
								class="chat"><i class="bi bi-chat-dots"></i></span></td>
						</tr>

						<tr>
							<td class="l1"><label class="labels">Site Address</label></td>
							<td><textarea rows="4" cols="70" class="t1" id="sAdd" name="siteAddress"
									style="width: 288px;"><%=obj.getString("siteAddress")%></textarea><span class="chat"> <i
									class="bi bi-chat-dots"></i></span></td>
							<td class="l1"><label class="labels">Description of<br>
									Works
							</label></td>
							<td><textarea rows="4" cols="70" class="t1" id="desc" name="descWork"
									style="width: 300px;"><%=obj.getString("descWork")%></textarea><span class="chat"> <i
									class="bi bi-chat-dots"></i></span></td>
						</tr>

						<tr>
							<td class="l1"><label class="labels">Lead Source</label></td>
							<td><select class="t1" id="lead" name="leadName" >
							...
							<td><textarea rows="4" cols="70" class="t1" id="leadData" name="leadData"
									style="width: 300px;"><%=obj.getString("leadData")%></textarea><span class="chat"> <i
									class="bi bi-chat-dots"></i></span></td>
						</tr>

						<tr>
							<td class="l1"><label class="labels">Consultant</label></td>
							<td><input type="text" class="t1" id="consultant" name="consultant" value="<%=obj.getString("consultant")%>"/><span
								class="chat"> <i class="bi bi-chat-dots"></i></span></td>
						</tr>

						<tr>
							<td class="l1"><label class="labels">End User</label></td>
							<td><input type="text" class="t1" id="endUser" value="" name="endUser"><span
								class="chat"> <i class="bi bi-chat-dots"></i></span></td>
						</tr>
					</table>
				...
				<fieldset
					...
					<table id="table3" style="font-family: 'tahoma';">
						...
						<tr>
							...
							<td><select class="t1" id="size" name="size" disabled>
							        <option value="<%=obj.getString("size")%>" selected><%=obj.getString("size")%></option>
									<option value="Select">Select</option>
							...
							<td><input type="text" class="t1" style="width: 96px;" id="inp1" name="bidStart" value="<%=obj.getString("bidStart")%>" ><span
								class="cal" id="calender1">&#128197</span></td>
							<td><input type="text" class="t1" style="width: 96px;" id="inp2" name="bidEnd" value="<%=obj.getString("bidEnd")%>"><span
								class="cal" id="calender2">&#128197</span></td>
							<td><input type="number" class="t1"
								style="width: 30px; margin-left: 27px;" id="bidWeek" name="bidWeek" value="<%=obj.getString("bidWeek")%>"> <span
								class="chat"> <i class="bi bi-chat-dots"></i></span></td>
						...
						<tr>
							...
							<td><input type="text" class="t1" id="aod" name="aoDate" value="<%=obj.getString("aoDate")%>"><span class="calender6">&#128197</span><span
								class="chat"> <i class="bi bi-chat-dots"></i></span></td>
							<td class="l1"><label class="labels">Project
									Programme</label></td>
							<td><input type="text" class="t1" style="width: 96px;" id="inp3"  name="ppStart" value="<%=obj.getString("ppStart")%>"><span
								class="calender3">&#128197</span></td>
							<td><input type="text" class="t1" style="width: 96px;" id="inp4" name="ppEnd" value="<%=obj.getString("ppEnd")%>"><span
								class="calender4">&#128197</span></td>
							<td><input type="number" class="t1"
								style="width: 30px; margin-left: 27px;" id="ppDuration" name="ppDuration" value="<%=obj.getString("ppDuration")%>"> <span
								class="chat"> <i class="bi bi-chat-dots"></i></span></td>
						...
						<tr>
							...
							<td><input type="number" class="t1" id="points" name="points" value="<%=obj.getString("points")%>"> <span
								class="chat"> <i class="bi bi-chat-dots"></i></span></td>
							...
							<td><select class="t1" style="width: 120px" id="rfi" name="deadLine">
							<option value="<%=obj.getString("deadLine")%>"><%=obj.getString("deadLine")%></option>
									<option value="select">Select</option>
						...
						<tr>
							...
							<td><select class="t1" id="survey" name="survey">
							<option value="<%=obj.getString("survey")%>"><%=obj.getString("survey")%></option>
							...
							<td><input type="text" id="r2" class="t1" name="deadLineDate" value="<%=obj.getString("deadLineDate")%>" style="width: 106px;"/><span id="r3" class="cal">&#128197</span></td>
						</tr>
					</table>
				...
				<table id="table4" style="font-family: 'tahoma';">
					<tr>
						<td class="l1"><label class="labels">Product
								Specified</label></td>
						<td><select class="t1" id="productSpec" name="productSpec">
								<option value="Select">Select</option>
						...
						<td><select class="t1" id="buildingType" name="buildingType">
								<option value="Select">Select</option>
					...
					<tr>
						...
						<td><select class="t1" id="endUserIndustry" name="endUserIndustry">
								<option value="Select">Select</option>
						...
						<td><select class="t1" id="projectType" name="projectType">
								<option value="Select">Select</option>
					...
					<tr>
						...
						<td><select class="t1" id="enquiryState" name="enqState">
								<option value="Select">Select</option>
						...
						<td><select class="t1" id="techType" name="techType">
								<option value="Select">Select</option>
			...
			<div class="toggle-content"
				...
				<table id="table5" style="font-family: 'tahoma';">
					<tr>
						...
						<td><select class="t1" id="eqType" name="enquiryFormat">
								<option value="Select">Select</option>
						...
						<td class="l1"><label class="labels">Documentation
								Received</label></td>
						<td><select class="t1" id="documentStatus" name="documentStatus">
								<option value="Select">Select</option>
					...
					<tr>
						...
						<td><select class="t1" id="nameSpec" name="nameSpec">
								<option value="Select">Select</option>
								<option value="Yes">Yes</option>
								<option value="No">No</option>
						</select> <span class="chat"> <i class="bi bi-chat-dots"></i></span></td>
						...
						<td><select class="t1" id="loc" name="location">
								<option value="Select">Select</option>
					...
					<tr>
						...
						<td><select class="t1" id="workBefore" name="beforeWork">
								<option value="Select">Select</option>
								<option value="Yes">Yes</option>
								<option value="No">No</option>
						</select> <span class="chat"> <i class="bi bi-chat-dots"></i></span></td>
						...
						<td><select class="t1" id="tAndc" name="terms">
								<option value="">Select</option>
								<option value="Yes">Yes</option>
								<option value="No">No</option>
						</select><span class="chat"> <i class="bi bi-chat-dots"></i></span></td>
					...
					<tr>
						...
						<td><select class="t1" id="pcg" name="pcg">
								<option value="">Select</option>
								<option value="Yes">Yes</option>
								<option value="No">No</option>
						</select> <span class="chat"> <i class="bi bi-chat-dots"></i></span></td>
						...
						<td class="l1"><label class="labels">Performance
								Bond ?</label></td>
						<td><select class="t1" id="pb" name="perfoBond">
								<option value="">Select</option>
								<option value="Yes">Yes</option>
								<option value="No">No</option>
						</select> <span class="chat"> <i class="bi bi-chat-dots"></i></span></td>
					...
					<tr>
						...
						<td><select class="t1" id="nec" name="nec">
								<option value="">Select</option>
								<option value="Yes">Yes</option>
								<option value="No">No</option>
						</select> <span class="chat"> <i class="bi bi-chat-dots"></i></span></td>
						...
						<td class="l1"><label class="labels">Damages Advised
								?</label></td>
						<td><select class="t1" id="damageAd" name="damage">
								<option value="">Select</option>
								<option value="Yes">Yes</option>
								<option value="No">No</option>
						</select> <span class="chat"> <i class="bi bi-chat-dots"></i></span></td>
					...
					<tr>
						<td class="l1"><label class="labels">Retention
								Advised ?</label></td>
						<td><select class="t1" id="retention" name="retention">
								<option value="Select">Select</option>
								<option value="Yes">Yes</option>
								<option value="No">No</option>
						</select> <span class="chat"> <i class="bi bi-chat-dots"></i></span></td>
						...
						<td><select class="t1" id="siteExp" name="siteExp">
								<option value="Select">Select</option>
			...
			<div class="toggle-content"
				...
				<table id="table6" style="font-family: 'tahoma';">
					<tr>
						...
						<td><input type="text" class="t1" id="qrn" name="QuoteNo" value="<%=obj.getString("qrn") %>" readonly></td>
					</tr>
					...
					<tr>
						...
						<td>
							<div class="check1">
								<label class="switch"> <input type="checkbox" id="ch1" name="ch1"
						...
						<div class="tog1"
							...
							<table id="table7" style="font-family: 'tahoma';">
								<tr>
									...
									<td><input type="date" class="t1" name="estimationRequiredDate" style="width: 102px">
									</td>

									<td class="l1"><label class="labels"
										style="margin-left: 60px;">Send Request to<span
											class="error"> *</span></label></td>
									<td><select class="t1" style="width: 140px" name="estimationSendRequest">
											<option value="Select">Select</option>
								...
								<tr>
									<td class="l1"><label class="labels">Comments<span
											class="error">*</span></label></td>
									<td><textarea rows="5" cols="70" class="t1" name="estimationComments"
											style="width: 270px;"></textarea></td>
							</table>
							<br>
							<div id="reqEst">Request Estimation</div>
						...
						<div class="tog2"
							...
							<table id="table7" style="font-family: 'tahoma';">
								<tr>
									...
									<td><input type="date" class="t1" style="width: 102px" name="designReqiredDate">
									</td>

									<td class="l1"><label class="labels"
										style="margin-left: 60px;">Send Request to<span
											class="error"> *</span></label></td>
									<td><select class="t1" style="width: 140px" name="designSendRequest">
											<option value="Select">Select</option>
											<option value="Super Admin">Super Admin</option>
											<option value="Andrew Redfern">Andrew Redfern</option>
											<option value="Narendra">Narendra</option>
								...
								<tr>
									<td class="l1"><label class="labels">Comments<span
											class="error">*</span></label></td>
									<td><textarea rows="5" cols="70" class="t1" name="designComments"
											style="width: 270px;"></textarea></td>
							</table>
							<br>
							<div id="reqEst">Request Design Calculation</div>
				...
				<table id="table7" style="font-family: 'tahoma';">
					<tr>
						...
						<td><select class="t1" id="bidSheetCriteria" name="bidSheetCriteria">
							<option value="Select">Select</option>
								<option value="Yes">Yes</option>
								<option value="No">No</option>
						</select></td>
				...
				<table id="table8" style="font-family: 'tahoma';">
					...
					<tr>
						...
						<td><select class="t1" id="quoteFormat" name="quoteFormat">
								<option value="Select">Select</option>
								<option value="Yes">Yes</option>
								<option value="No">No</option>
						</select></td>
						...
						<td><input type="text" class="t1" id="dateonQuote" name="dateonQuote" autocomplete="off"><span id="calendar7"
						...
						<tr>
							...
							<td><input type="text" class="t1" style="" id="projectCost" name="projectCost"></td>
							<td style="width: 112px"></td>
							<td class="l1"><label class="labels">Overall Project
									Sell(£)<span class="error"> *</span>
							</label></td>
							<td><input type="text" class="t1" style="" id="projectSell" name="projectSell"></td>
						</tr>
					</table>
				<div id="drop4">
				<div class="drop">
		...
		<div class="toggle6">
			...
			<div class="toggle-content"
				style="width: 100%; border: 1px solid #C5D0DC; border-top: none; margin-top: -6px;">
				<%  String str=prj.getAllComments(obj.getString("qrn"));
		...
		<textarea rows="4"  class="t1" style="width:98%;max-width: 100%" maxlength="2000" id="comments" name="comments"></textarea>

		<div id="buttons">
			<input type="button" id="btn3" value="New Link">
			<input type="button" id="btn4" value="Link Project"/>
			<input type="button" id="btn5" value="Save"/>
			<input type="submit" id="btn6" onclick="validate()" value="Quote Prepared"/>
			<input type="reset" id="btn7" value="Cancel"/>
		</div>
	</form>
	...
	var ch1=document.getElementById("ch1");
	    ...
	    var survey=document.getElementById('survey');
		 if (survey.value == null || survey.value == "" || survey.value=="Select") {
			...
			var endUserIndustry=document.getElementById('endUserIndustry');
			if(endUserIndustry.value==null || endUserIndustry.value=="" || endUserIndustry.value=="Select"){
				setError(endUserIndustry,"Choose valid Product Specification");
				validForm=false;
			}else{
				removeError(endUserIndustry);	
			}
			...
			if(projectCost.value==null || projectCost.value=="" || isNaN(projectCost.value)){
			...
			if(projectSell.value==null || projectSell.value=="" || isNaN(projectSell.value)){
