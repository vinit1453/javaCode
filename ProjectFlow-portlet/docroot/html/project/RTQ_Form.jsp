...
<p:renderURL var="homepage">
 		<p:param name="jspPage" value="/html/project/view.jsp"></p:param>
</p:renderURL>
<head>
...
$(document).ready(function() {
	    ...
	    $("#inp3").focus();
	  	 ...
	  	 $("#inp4").datepicker({dateFormat: 'dd/mm/yy',numberOfMonths: 3, showCurrentAtPos:0,minDate:$("#inp3").val()});
		    ...
		    $("#inp5").focus();
		  	...
		  	$("#aod").datepicker({dateFormat: 'dd/mm/yy',numberOfMonths: 3, showCurrentAtPos:0,minDate:$("#inp1").val(),maxDate:$("#inp3").val()});
	...
	$("#aod").datepicker("option", "minDate",$("#inp1").val());
	$("#inp2").datepicker("option", "minDate",$("#inp1").val());
...
<body>
	<form name="frm1" id="frm1" action="<%=action%>" method="post">
				...
				<fieldset
					...
					<table id="table1" style="font-family: 'tahoma';">
						<tr>
							...
							<td><input type="text" class="t1" name="customer" id="cna"/> <i
						...
						<tr>
							...
							<td class="l1"><label class="labels"
								style="margin-left: 160px;">Postal Code<span
									class="error">*</span></label></td>
							<td><input type="text" class="t1" id="pCode" name="pCode"> <i
								class="bi bi-chat-dots"></i></td>
						</tr>
						...
						<tr>
							<td class="l1"><label class="labels">Contact Name<span
									class="error">*</span></label></td>
							<td><input type="text" class="t1" id="conName" name="conName"/></td>
							<td><label class="labels" style="margin-left: 246px;">Email<span
									class="error">*</span></label></td>
							<td><input type="text" class="t1" id="email" name="email"></td>
						</tr>

						<tr>
							<td class="l1"><label class="labels">Phone<span
									class="error">*</span></label></td>
							<td><input type="text" class="t1" id="ph" name="ph"></td>
						</tr>
					</table>
				</fieldset>
				<br>
					...
					<table id="table2" style="font-family: 'tahoma';">
						<tr>
							<td class="l1"><label class="labels">Project Name<span
									class="error">*</span></label></td>
							<td><input type="text" class="t1" id="pname" name="projectName" autocomplete="off"> <i
								class="bi bi-chat-dots"></i></td>
							<td class="l1"><label class="labels">Site Name<span
									class="error">*</span></label></td>
							<td><input type="text" class="t1" id="sname" name="siteName"/> <i
								class="bi bi-chat-dots"></i></td>
						</tr>

						<tr>
							<td class="l1"><label class="labels">Site Address</label></td>
							<td><textarea rows="4"  class="t1" id="sAdd" name="siteAddress"
							...
							<td><textarea rows="4" cols="100" class="t1" id="desc" name="descWork"
						...
						<tr>
							...
							<td><input type="text" class="t1" id="consultant" name="consultant"> <i
								class="bi bi-chat-dots"></i></td>
							<td><label class="labels" style="margin-left: 64px">Add
									this project to my 
									WatchList
							</label></td>
							<td><input type="checkbox" class="t1" id="ch1" name="ch1"></td>
						</tr>
				...
				<fieldset
					...
					<table id="table3" style="font-family: 'tahoma';">
						...
						<tr>
							...
							<td><select class="t1" id="size" name="size">
										<option value="Select">Select</option>
							...
							<td class="l1"><label class="labels">Bid Programme<span
									class="error">*</span></label></td>
							<td><input type="text" id="inp1" class="t1" name="bidStart" autocomplete="off"
								style="width: 96px;"><span id="calender1">&#128197;</span>
							</td>
							<td style="width: 17%"><input type="text" id="inp2" name="bidEnd" autocomplete="off"
								class="t1" style="width: 96px;"> <span id="calender2">&#128197;</span></td>
							<td><input type="number" class="t1" style="width: 30px;" id="bidWeek" name="bidWeek" readonly>
						...
						<tr>
							...
							<td><input type="text" class="t1" id="aod" name="aoDate" autocomplete="off"/><span
								id="calender6">&#128197;</span> <i
								class="bi bi-chat-dots"></i></td>
							<td class="l1"><label class="labels">Project
									Programme<span class="error">*</span>
							</label></td>
							<td><input type="text" id="inp3" class="t1" name="ppStart" autocomplete="off"
								style="width: 96px;"><span id="calender3">&#128197;</span>
							</td>
							<td><input type="text" id="inp4" class="t1" name="ppEnd" autocomplete="off"
								style="width: 96px;"><span id="calender4">&#128197;</span>
							</td>
							<td><input type="number" class="t1" id="ppDuration" name="ppDuration" style="width: 30px;"  readonly>
								<i class="bi bi-chat-dots"></i></td>
						...
						<tr>
							...
							<td><input type="number" class="t1" id="points" name="points" min=0> <i
								class="bi bi-chat-dots" ></i></td>
							...
							<td><select class="t1" id="submit" name="deadLine" style="width: 156px">
									<option value="select">Select</option>
						...
						<tr>
							...
							<td id="deadline2"><input type="text" class="input-mini" id="inp5" class="t1" name="deadLineDate" autocomplete="off"><span
			...
			<div class="toggle-content"
				...
				<table id="table4" style="font-family: 'tahoma';">
					...
					<tr>
						...
						<td><select class="t1" id="endUser" name="endUser">
								<option value="Select">Select</option>
				...
				<table id="table5" style="font-family: 'tahoma';">
					...
					<tr>
						...
						<td style="text-align: center"><span id="file1"><i
								class="bi bi-folder2" id="fileUpload1"></i></span></td>
		...
		<div class="toggle4">
         ...
         <input id="qrn" name="QuoteNo" type="hidden"/>
 		<label class="labels">Comments</label>
		<textarea rows="4" cols="180" maxlength="2000" class="t1" id="comments" name="comments"
			style="width: 99%; max-width: 99%; border: 1px solid #eaeaea !important;"></textarea>

		<div id="buttons">
			<input  type="button" id="btn3" value="Save"/>
			<input type="reset" id="btn4" value="Reset"/>
			<input id="btn6" type="submit"  value="Submit" onclick="validate()"/>
			<input type="button" id="btn7" onclick="window.location.reload()" value="Cancel"/>
		</div>
	</form>
...
function setup(id) {
	let options = {
		...
		previewTemplate : '<div class="dz-preview dz-file-preview" id="dropZone1" name="dropZone1">'
...
/* 	/accepts only:DE14 2WQ */
	...
	var ch1=document.getElementById("ch1");
		...
		var ppStart = document.getElementById('inp3');
		 ...
		 var bidDuration=document.getElementById('ppDuration');
		var points= document.getElementById('points');           
	    var deadLine=document.getElementById('submit'); 
		...
		var deadLineDate=document.getElementById('inp5');
			...
			if(Comments.value==null || Comments.value==""){
				setError(Comments,"Enter valid Comments");
				validForm=false;
			...
			if (validForm==true) {
				...
				document.getElementById('qrn').value=generate();
				alert("success");
				return validForm;
