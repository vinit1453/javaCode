	...
	<div>
		<form id="project" name="myForm" action="<%=add%>" method="post" >
			...
			<div style="border: 0.25px solid #D3D3D3;" id="panel1">
				...
				<table style="margin-left: 10%;">
					...
					<tr>
						...
						<td class="order_date"><input type="text" id="inp1" name="aod" autocomplete="off"></td>
					...
					<tr>
						...
						<td class="order_date"><input type="text" id="inp2" autocomplete="off"></td>
					...
					<tr>
						...
						<td class="order_date"><input type="text" id="inp3" autocomplete="off"></td>
					...
					<table>
						...
						<tr>
							...
							<td style="margin-left: 20%; text-align: right;"><label>Scope
									of works</label></td>
							<td><textarea id='sow'
									name="scopeOfWorks" placeholder=""></textarea>
							</td>
						</tr>
			...
			<div>
				...
				<textarea id="comment" style="width: 99%" rows="4" name="comment"></textarea>
			</div>
