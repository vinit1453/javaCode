...
<body>
	<div class="a">
			...
			<div class="toggle-content" style="border: 1px solid rgba(0, 0, 0, 0.3); margin-top: -6px;">
				<div style="display: flex; flex-direction: row; margin: 15px; padding: 2px">
					...
					<div style="margin: 0 10px;">
						<input type="" id="quoteSub" name="quoteSub" />
					</div>
		...
		<div class="3" style="margin-top: 10px;">
			...
			<div>
				<textarea class="ta" id="comments" name="comments" rows="3" style="width: 98%; max-width: 100%"></textarea>
			</div>
		</div>
		<div class="btns" style="text-align: end">
			...
			<div>
				...
				<input class="btn btn-primary" type="submit" onclick="validate()" id="btn3" value="Save"/>
