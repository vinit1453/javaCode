...
<body>
	<form name="frm1" id="frm1">
				...
				<fieldset
					...
					<table id="table1" style="font-family: 'tahoma';">
						<tr>
							...
							<td><input type="text" class="t1" name="cna" id="cna"/> <i
					...
					<table id="table2" style="font-family: 'tahoma';">
						<tr>
							<td class="l1"><label class="labels">Project Name<span
									class="error">*</span></label></td>
							<td><input type="text" class="t1" id="pname" name="pname"> <i
								class="bi bi-chat-dots"></i></td>
							<td class="l1"><label class="labels">Site Name<span
									class="error">*</span></label></td>
							<td><input type="text" class="t1" id="sname" name="sname"/> <i
								class="bi bi-chat-dots"></i></td>
						</tr>

						<tr>
							<td class="l1"><label class="labels">Site Address</label></td>
							<td><textarea rows="4"  class="t1" id="sAdd" name="sAdd"
					...
					<table id="table3" style="font-family: 'tahoma';">
						...
						<tr>
							...
							<td class="l1"><label class="labels">Bid Programme<span
									class="error">*</span></label></td>
							<td><input type="text" id="inp1" class="t1" name="inp1"
								style="width: 96px;"><span id="calender1">&#128197;</span>
							</td>
							<td style="width: 17%"><input type="text" id="inp2" name="inp2"
						...
						<tr>
							...
							<td><input type="text" class="t1" id="aod" name="aod"/><span
								id="calender6">&#128197;</span> <i
								class="bi bi-chat-dots"></i></td>
							<td class="l1"><label class="labels">Project
									Programme<span class="error">*</span>
							</label></td>
							<td><input type="text" id="inp3" class="t1" name="inp3"
								style="width: 96px;"><span id="calender3">&#128197;</span>
							</td>
							<td><input type="text" id="inp4" class="t1" name="inp4"
						...
						<tr>
							...
							<td><select class="t1" id="submit" name="submit" style="width: 156px">
									<option value="select">Select</option>
						...
						<tr>
							...
							<td id="deadline2"><input type="text" class="input-mini" id="inp5" class="t1" name="inp5"><span
			...
			<div class="toggle-content"
				...
				<table id="table4" style="font-family: 'tahoma';">
					...
					<tr>
						...
						<td><select class="t1" id="enquiryState" name="enquiryState">
								<option value="Select">Select</option>
				...
				<table id="table5" style="font-family: 'tahoma';">
					<tr>
						<td class="l1"><label class="labels">Enquiry Format<span
								class="error">*</span></label></td>
						<td><select class="t1" id="eqType" name="eqType">
									<option value="Select">Select</option>
					...
					<tr>
						...
						<td class="l1"><label class="labels">Location<span
								class="error">*</span></label></td>
						<td><select class="t1" id="loc" name="loc">
								<option value="Select">Select</option>
					...
					<tr>
						...
						<td><select class="t1" id="workBefore" name="workBefore">
								<option value="Select">Select</option>
								<option value="Yes">Yes</option>
								<option value="No">No</option>
						</select> <i class="bi bi-chat-dots"></i></td>
						...
						<td><select class="t1" id="tAndc" name="tAndc">
								<option value="select">Select</option>
								<option value="Yes">Yes</option>
								<option value="No">No</option>
						</select> <i class="bi bi-chat-dots"></i></td>
					...
					<tr>
						...
						<td class="l1"><label class="labels">Performance
								Bond ?</label></td>
						<td><select class="t1" id="pb" name="pb">
								<option value="select">Select</option>
								<option value="Yes">Yes</option>
								<option value="No">No</option>
						</select> <i class="bi bi-chat-dots"></i></td>
					...
					<tr>
						...
						<td class="l1"><label class="labels">Damages Advised
								?</label></td>
						<td><select class="t1" id="damageAd" name="damageAd">
								<option value="select">Select</option>
								<option value="Yes">Yes</option>
								<option value="No">No</option>
						</select> <i class="bi bi-chat-dots"></i></td>
		...
		<div id="buttons">
			...
			<button id="btn6" type="submit" onclick="validate()">Submit</button>
			<button id="btn7" onclick="window.location.reload()">Cancel</button>
		</div>
	</form>
